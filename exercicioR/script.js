...
*/
alert("Bem-vindo!");
let maior = Number.MIN_SAFE_INTEGER; // Inicializa com o menor valor possível para comaração;
...
if(maior===Number.MIN_SAFE_INTEGER && menor === Numer.MAX_SAFE_INTEGER){
    alert("Nenhum valor positivo foi digitado.");
}else{
     document.body.innerHTML+= `<p>\Maior valor informado: ${maior}</p>`;
